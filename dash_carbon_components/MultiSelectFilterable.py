...
- selectedItems (list of strings; optional): The list of the selected items"""
    @_explicitize_args
    def __init__(self, disabled=Component.UNDEFINED, locale=Component.UNDEFINED, light=Component.UNDEFINED, selectionFeedback=Component.UNDEFINED, direction=Component.UNDEFINED, id=Component.REQUIRED, invalid=Component.UNDEFINED, invalidText=Component.UNDEFINED, items=Component.REQUIRED, label=Component.REQUIRED, size=Component.UNDEFINED, titleText=Component.UNDEFINED, selectedItems=Component.UNDEFINED, **kwargs):
        self._prop_names = ['disabled', 'locale', 'light', 'selectionFeedback', 'direction', 'id', 'invalid', 'invalidText', 'items', 'label', 'size', 'titleText', 'selectedItems']
        self._type = 'MultiSelectFilterable'
        self._namespace = 'dash_carbon_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['disabled', 'locale', 'light', 'selectionFeedback', 'direction', 'id', 'invalid', 'invalidText', 'items', 'label', 'size', 'titleText', 'selectedItems']
